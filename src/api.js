...
export const getApi = {
  ...
  getUser: () =>
    axios.get("account/user").catch((error) => {
  ...
  // 챌린지 인증 전부다
  getDetailAll: (challenge_id) =>
    axios.get(`verification/list/${challenge_id}`),
  // 챌린지 랭크
...
export const postApi = {
  ...
  // 챌린지 인증샷 보내기
  postSubmitPost: (challenge_id, data) =>
    axios.post(`/verification/create/${challenge_id}`, data),
};
